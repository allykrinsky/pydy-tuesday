...
px.line(intake_trends, x='intake_month', y='count', title='Animal Intakes Over Time')
...
px.pie(outcome_counts, names='outcome_type', values='count', title='Distribution of Outcomes')
...
px.histogram(df, x='age_at_intake', nbins=30, title='Age Distribution of Animals at Intake')
